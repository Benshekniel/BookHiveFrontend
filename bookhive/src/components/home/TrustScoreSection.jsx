...
const TrustScoreSection = () => {
  ...
  return (
    <div className="py-16" style={{ backgroundColor: '#407aff', color: '#FFFFFF' }}>
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="mt-3 max-w-2xl mx-auto" style={{ color: '#1A3AFF' }}>
            ...
            <div className="relative w-80 h-80">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center transition-all duration-200 transform hover:shadow-lg hover:-translate-y-2">
                  ...
                  <p className="mt-2 max-w-xs mx-auto" style={{ color: '#1A3AFF' }}>
                  ...
                  <div className="mt-4">
                    ...
                    <span className="ml-2" style={{ color: '#1A3AFF' }}>Excellent</span>
                  </div>
                </div>
              </div>
            </div>
