      ...
      <nav className="bg-white shadow-md sticky top-0 z-50">
        <div className="container mx-auto px-4 py-3 max-w-[1400px]">
          <div className="flex items-center justify-between">
            ...
            {/* Search Bar - Desktop */}
            <div className="hidden lg:flex flex-grow max-w-md mx-6">
              <div className="relative w-full">
                <input
                  type="text"
                  placeholder="Search books, authors, genres..."
                  className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-400 focus:border-transparent transition-all text-sm"
                />
            ...
            <div className="hidden lg:flex items-center space-x-6">
              ...
              <div className="relative">
                ...
                >
                  <img
                    src={user?.profileImage || "https://images.pexels.com/photos/937481/pexels-photo-937481.jpeg"}
                    alt="Profile"
