...
const Footer = () => {
  return (
    <footer className="bg-blue text-white" style={{ backgroundColor: '#1d5ed8' }}>
      <div className="container mx-auto px-4 py-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <Logo variant="light" />
            <p className="mt-4 text-sm leading-relaxed" style={{ color: '#DBEAFE' }}>
          ...
          <div>
            <h3 className="text-lg font-semibold mb-4 border-b border-blue-light pb-2" style={{ fontFamily: "'Poppins', system-ui, sans-serif", borderColor: '#DBEAFE' }}>
              Quick Links
            </h3>
            <ul className="space-y-2 text-sm" style={{ color: '#DBEAFE' }}>
              <li><Link to="/books" className="hover:text-yellow transition-colors duration-200" style={{ color: '#DBEAFE' }}
                onMouseOver={(e) => (e.target.style.color = '#FFC107')}
                onMouseOut={(e) => (e.target.style.color = '#DBEAFE')}
              >Browse Books</Link></li>
              <li><Link to="/circles" className="hover:text-yellow transition-colors duration-200" style={{ color: '#DBEAFE' }}
                onMouseOver={(e) => (e.target.style.color = '#FFC107')}
                onMouseOut={(e) => (e.target.style.color = '#DBEAFE')}
              >Book Circles</Link></li>
              <li><Link to="/how-it-works" className="hover:text-yellow transition-colors duration-200" style={{ color: '#DBEAFE' }}
                onMouseOver={(e) => (e.target.style.color = '#FFC107')}
                onMouseOut={(e) => (e.target.style.color = '#DBEAFE')}
              >How It Works</Link></li>
              <li><Link to="/about" className="hover:text-yellow transition-colors duration-200" style={{ color: '#DBEAFE' }}
                onMouseOver={(e) => (e.target.style.color = '#FFC107')}
                onMouseOut={(e) => (e.target.style.color = '#DBEAFE')}
              >About Us</Link></li>
              <li><Link to="/faq" className="hover:text-yellow transition-colors duration-200" style={{ color: '#DBEAFE' }}
                onMouseOver={(e) => (e.target.style.color = '#FFC107')}
                onMouseOut={(e) => (e.target.style.color = '#DBEAFE')}
              >FAQs</Link></li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm" style={{ color: '#DBEAFE' }}>
              ...
              <li className="flex items-center">
                ...
                <a href="mailto:info@bookhive.lk" className="hover:text-yellow transition-colors duration-200" style={{ color: '#DBEAFE' }}
                  onMouseOver={(e) => (e.target.style.color = '#FFC107')}
                  onMouseOut={(e) => (e.target.style.color = '#DBEAFE')}
                >info@bookhive.lk</a>
              </li>
              <li className="flex items-center">
                ...
                <a href="tel:+94112581245" className="hover:text-yellow transition-colors duration-200" style={{ color: '#DBEAFE' }}
                  onMouseOver={(e) => (e.target.style.color = '#FFC107')}
                  onMouseOut={(e) => (e.target.style.color = '#DBEAFE')}
                >+94 11 258 1245</a>
              </li>
          ...
          <div>
            ...
            <p className="text-sm" style={{ color: '#DBEAFE' }} mb-3>
        ...
        <div className="border-t mt-10 pt-6 text-center text-sm" style={{ borderColor: '#DBEAFE', color: '#DBEAFE' }}>
