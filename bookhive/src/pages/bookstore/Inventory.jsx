...
//     if (stock === 0) {
//       return <span className="px-3 py-1 text-xs font-semibold bg-red-100 text-red-800 rounded-full border border-red-200">Out of Stock</span>;
//     } else if (stock <= 5) {
//       return <span className="px-3 py-1 text-xs font-semibold bg-orange-100 text-orange-800 rounded-full border border-orange-200">Low Stock</span>;
//     } else {
//       return <span className="px-3 py-1 text-xs font-semibold bg-green-100 text-green-800 rounded-full border border-green-200">Active</span>;
//     }
//   };
...
//                   156 total books (124 new, 32 used)
//                 </p>
//               </div>
//             </div>
...
//                   <Package className={`w-6 h-6 ${stat.textColor}`} />
//                 </div>
//               </div>
//             </div>
//           ))}
...
//                     <td className="p-4 text-sm text-slate-700">{book.category}</td>
//                     <td className="p-4">{getConditionBadge(book.condition)}</td>
//                     <td className="p-4">
//                       <span className={`font-semibold ${book.stock === 0 ? 'text-red-600' : book.stock <= 5 ? 'text-orange-600' : 'text-slate-700'}`}>
//                         {book.stock}
//                       </span>
//                     </td>
//                     <td className="p-4 font-semibold text-slate-800">${book.price}</td>
//                     <td className="p-4">{getStatusBadge(book.status, book.stock)}</td>
//                     <td className="p-4">
//                       <div className="flex items-center space-x-2">
...
//           <p className="text-sm text-slate-600">Showing 1 to 5 of 156 results</p>
//           <div className="flex space-x-2">
