...
const HomePage = () => {
  const honeycombBgStyle = {
    backgroundImage: 'radial-gradient(transparent 0%, transparent 20%, rgba(255, 214, 57, 0.05) 20%), radial-gradient(transparent 0%, transparent 20%, rgba(64, 122, 255, 0.05) 20%)', // Updated to yellow, blue
